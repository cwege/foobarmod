...
public class MagicgrassBlock extends FoobarmodModElements.ModElement {
	@ObjectHolder("foobarmod:magicgrass")
	public static final Block block = null;
	public MagicgrassBlock(FoobarmodModElements instance) {
		super(instance, 6);
	}
