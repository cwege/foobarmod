...
public class SternchenBlockBlock extends FoobarmodModElements.ModElement {
	@ObjectHolder("foobarmod:sternchen_block")
	public static final Block block = null;
	public SternchenBlockBlock(FoobarmodModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sternchen_block");
		}
