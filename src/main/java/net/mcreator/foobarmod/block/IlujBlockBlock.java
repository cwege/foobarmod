...
public class IlujBlockBlock extends FoobarmodModElements.ModElement {
	@ObjectHolder("foobarmod:iluj_block")
	public static final Block block = null;
	public IlujBlockBlock(FoobarmodModElements instance) {
		super(instance, 7);
	}
